...
export function getMemoryPanelHtml(): string {
  // --- Global memory ---
  const { loadUserMemory } = require('../services/userMemoryService.js') as typeof import('../services/userMemoryService.js');
  ...
  if (!root) {
    ...
    try {
      const { readKnowledge } = require('../services/learnedMemoryServiceIO.js') as typeof import('../services/learnedMemoryServiceIO.js');
