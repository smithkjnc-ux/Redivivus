...
import { DiagResult, checkWorkspace, checkChassisDir, checkConfigFile, checkServiceExists, checkInitState, checkApiKey, checkProviderReachable, checkSystemPrompt } from './selfDiagnosticChecks.js';
