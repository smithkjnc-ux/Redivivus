...
export { shouldAutoSave } from './chatPanelAutoSaveInference.js';
...
export async function autoSaveAndOpen(
  ...
  try {
    const { buildEvents } = await import('./services/buildEvents.js');
...
export { shouldDeleteFiles, deleteRequestedFiles, identifyFilesToDelete } from './chatPanelAutoSaveDelete.js';
