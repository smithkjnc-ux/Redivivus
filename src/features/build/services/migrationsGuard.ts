...
// [DONE] PRISMA_KW, prismaFieldsFromContent, droppedSchemaFields, schemaCodeMismatch, isApplyingPrismaMigrate,
// looksLikeMigrationApply moved to migrationsGuardPrisma.ts (Rule 9 split)
export { prismaFieldsFromContent, droppedSchemaFields, schemaCodeMismatch, isApplyingPrismaMigrate, looksLikeMigrationApply } from './migrationsGuardPrisma.js';
