...
import { inferExtension, deriveFileBase, extractCodeFromResponse } from './chatPanelBuildInference.js';
...
import { appendCompileAction, maybeAutoCompile } from './chatPanelBuildPipeline.js';
