...
${isFirst ? 'Start with <!DOCTYPE html>, <html>, <head>, <style> (include `body { display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; background: #222; overflow: hidden; } canvas { display: block; }` to center the canvas), <body>, <canvas>, <script>.' : ''}
