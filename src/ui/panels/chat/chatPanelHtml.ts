...
export function buildChatHtml(conversation: ChatMessage[], header?: ChatHeaderInfo, progress?: SetupProgress): string {
  ...
  <div class="header">
    <div class="header-left">
      <div style="display:flex;align-items:center;gap:7px;"><img src="data:image/svg+xml;base64," height="22" width="22" style="display:block;flex-shrink:0;" alt="R" /><span style="font-size:13px;color:#5eead4;letter-spacing:3px;font-weight:700;text-decoration:underline;">EDIVIVUS</span></div>
