...
import { ChatMessage } from './chatPanelHtml';
import type { MessageHandlerDeps } from '../../../core/routing/chatPanelMessages';
import { buildAIPrefix, processAIResponse } from '../../../core/ai/chatPanelAI';
import type { ArchitectAction } from './chatPanelMsgArchitect';
import { _architectReviews, _architectActions } from './chatPanelMsgArchitect';
