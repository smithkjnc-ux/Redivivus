...
export function buildResultCard(
  ...
  elapsedSec = 0,
  snapshotId?: string,
  captureResult: import('../../../services/vault/vaultAutoCapture').CaptureResult | number = 0,
  isModification = false,
  ledgerSummary?: import('../../../services/build/buildLedgerService').LedgerSummaryLine[],
  feedbackId?: string,
  projectRoot?: string,
): string {
...
__END_RESULT_CARD__${undoToken}${breakdownToken}${feedbackToken}${openWorkspaceToken}${editVisuallyToken}`;
}
