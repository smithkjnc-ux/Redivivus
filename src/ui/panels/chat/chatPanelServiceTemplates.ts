...
import type { ServiceTemplate} from './chatPanelServiceTemplatesA';
import { FIREBASE_TEMPLATE, SUPABASE_TEMPLATE } from './chatPanelServiceTemplatesA';
import { STRIPE_TEMPLATE, OPENAI_TEMPLATE } from './chatPanelServiceTemplatesB';
